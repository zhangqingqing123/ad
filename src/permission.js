...
function hasPermission(roles, route) {
  ...
  switch (route.meta.type){
  		case 1://一级菜单
  			return roles.menuList.some(role => function(){if(role){return route.meta.permission.indexOf(role) >= 0}}(role) >= 0);
  		case 2://二级菜单
  			return roles.permissionList.some(role => function(){if(role){return route.meta.permission.indexOf(role) >= 0}}(role) >= 0);
  		default:
  			return false;
  	}
}
