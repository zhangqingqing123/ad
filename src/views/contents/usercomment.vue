<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-input clearable class="filter-item" style="width: 200px;" placeholder="请输入用户名称" v-model="listQuery.userNickName">
      </el-input>
      <el-date-picker
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="评论对象" prop="retailPrice">
      </el-table-column>
