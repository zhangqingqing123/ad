<template>
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" min-width="100" label="规格" prop="specifications">
      	<template slot-scope="scope">
      		<span v-for="v in scope.row.specifications">{{v}}</span>
	    </template>
      </el-table-column>
      
      <el-table-column align="center" min-width="100" label="最高价格" prop="singleMaxPrice">
      </el-table-column>
      
      <el-table-column align="center" min-width="100" label="最低价格" prop="singleMinPrice">
      </el-table-column>
...
<script>
import {orderListBargain} from '@/api/bargain'
...
export default {
	...
	methods:{
		...
		getList() {
	      ...
	      orderListBargain(this.listQuery).then(response => {
