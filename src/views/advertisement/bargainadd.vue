  ...
  <div class="app-container calendar-list-container">
   ...
   <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" ref="dataForm" :model="dataForm" status-icon label-position="left" style='width: 400px; margin-left:50px;'>
        ...
        <el-form-item label="规定每次砍价最多砍多少" prop="singleMaxPrice">
          <el-input v-model="dataForm.singleMaxPrice"></el-input>
        </el-form-item>
        <!--选择规格-->
        <el-form-item label="请选择产品的规格" prop="specificationId">
	        <template>
        ...
        <el-form-item label="砍价时间段" class="filter-item" style="margin-left: 10px;">
		        <el-date-picker
