<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit highlight-current-row>
	  ...
	  <!--<el-table-column align="center" label="库存数量" prop="amountNumber">
      </el-table-column>-->
...
import { listVendorGoods, deleteVendorGoods } from '@/api/vendorGoods'
...
//  },
    ...
    handleUpdate(row) {
      ...
      //this.$router.push({ path: '/goods/add', query: { id: row.id }})
    },
    showDesc(desc) {
