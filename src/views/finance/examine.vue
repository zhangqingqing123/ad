		...
		methods: {
			...
			handleDownload() {
				...
				import('@/vendor/Export2Excel').then(excel => {
					const tHeader = ['提现单号', '申请时间', '用户名', '手机号', '提现状态', '申请提现金额', '应打款金额','账户余额','打款时间','操作人']
					const filterVal = ['accountNumber', 'createdAt','userName', 'phone', 'reflectType', 'money', 'money','balance','makeMoneyTime','makeMoneyManagerName']
					excel.export_json_to_excel2(tHeader, this.list, filterVal, '用户提现信息')
