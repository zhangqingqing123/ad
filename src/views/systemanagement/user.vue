	    ...
	    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
	      <el-form :rules="rules" ref="dataForm" :model="dataForm" status-icon label-position="left" label-width="100px" style='width: 400px; margin-left:50px;'>	       
	        ...
	        <el-form-item label="选择角色" prop="roleId">
	           <el-select  id="specifications" v-model="dataForm.roleId">
	        		<el-option :value="v.id" v-for="v in listRole" :label="v.roleName" :key="v.id">
	        		</el-option>
	        	</el-select>
	        </el-form-item>	        
	        <el-form-item label="管理地点" prop='selectedOptions'>
	        <el-cascader
...
import { listRole,addUserRole} from '@/api/systemanagement'
...
// 		selectedOptions:[
//					{ required: true, message: '管理地点不能为空', trigger: 'blur' },
//				],
		roleId:	[
...
//	列表
    ...
    getListRole(){
      listRole(this.roleQuery).then(response => {
